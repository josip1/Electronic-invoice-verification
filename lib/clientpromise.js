...
const computeVal = require(__dirname+'/computeVal.js');
const requestPromise = require('request-promise');
 
module.exports.runInit = async function (initObj) {
    ...
    try {
        ...
        let retArr = await Promise.all([fs.readFile(path.resolve(certDir,initObj.config.tlsCertFile)),
...
module.exports.runFursMes = async function(initObj) {
    ...
    const promRes = await requestPromise(options);
    let response = "";
    try {
